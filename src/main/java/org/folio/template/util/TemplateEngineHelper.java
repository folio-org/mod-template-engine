...
public final class TemplateEngineHelper {
  ...
  public static Response mapExceptionToResponse(Throwable throwable) {
    ...
    if (throwable instanceof BadRequestException) {
      LOG.error("mapExceptionToResponse:: Bad request exception occurred", throwable);
    ...
    if (throwable instanceof NotFoundException) {
      LOG.error("mapExceptionToResponse:: Not found exception occurred", throwable);
    ...
    if (throwable instanceof InUseTemplateException) {
      LOG.error("mapExceptionToResponse:: In use template exception occurred", throwable);
      return Response.status(HttpStatus.SC_BAD_REQUEST)
